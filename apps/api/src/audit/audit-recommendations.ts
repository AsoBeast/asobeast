...
export const CHECK_EFFORT: Record<AuditCheckId, AuditEffort> = {
  ...
  'screenshots-first-three': 'hours',
  'screenshots-text-overlays': 'hours',
  'screenshots-consistent': 'hours',
  'screenshots-localized': 'hours',
  'screenshots-device-frames': 'hours',
  'preview-video-present': 'weeks',
  'ratings-average': 'weeks',
  'ratings-volume': 'weeks',
  'ratings-recent': 'weeks',
  'ratings-current-version': 'weeks',
  'icon-distinctive': 'hours',
  'icon-simple': 'hours',
  'icon-category-fit': 'hours',
  'icon-no-text': 'hours',
...
export const CHECK_TARGET: Record<AuditCheckId, AuditTarget> = {
  ...
  'screenshots-first-three': 'store-console',
  'screenshots-text-overlays': 'store-console',
  'screenshots-consistent': 'store-console',
  'screenshots-localized': 'store-console',
  'screenshots-device-frames': 'store-console',
  ...
  'icon-distinctive': 'store-console',
  'icon-simple': 'store-console',
  'icon-category-fit': 'store-console',
