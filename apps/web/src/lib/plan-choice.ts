...
export function stalled(plan: AccountPlan): boolean {
  return plan.subscribed && !plan.entitled;
}
...
export function planAction(
  ...
  return plan.entitled ? "change" : "resume";
}
...
export function planCallToAction(plan: AccountPlan): string {
  ...
  return plan.subscribed ? "Resume plan" : "Choose a plan";
}
