...
export const KEYWORD_TOOLS: ReadTool[] = [
  defineReadTool({
    ...
    description:
      "Tracked keywords for one app with traffic and difficulty on the stored 0-10 scale, volume and opportunity on a 0-100 scale, and the latest checked position. Position is 1-based; null means checked but not found within the row's latestDepth (render as >latestDepth), and a null latestDepth means the keyword has never been checked. Keywords are per-market: pass country to scope to one storefront.",
