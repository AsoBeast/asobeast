...
| Difference | Effect |
| --- | --- |
| Neither store's suggest endpoint carries a popularity value | asobeast probes how early each store suggests the keyword instead. See [Traffic, difficulty and opportunity](/concepts/scoring#how-is-traffic-estimated) |
