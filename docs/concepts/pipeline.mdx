...
| `CRON_SCORING` | `0 4 * * 0` | Sunday 04:00 | Recomputes popularity and difficulty for tracked keywords |
...
| Apple score job | 2 to 10 requests |
| Google Play score job | 12 to 20 requests |
