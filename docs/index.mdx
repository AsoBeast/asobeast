...
<AccordionGroup>
  ...
  <Accordion title="Scores keywords transparently" icon="gauge">
    Popularity and difficulty carry their evidence source, calculation version, capture date and confidence. See [Popularity, difficulty and opportunity](/concepts/scoring).
  </Accordion>
