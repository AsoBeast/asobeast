...
Then bump the version everywhere Release Please would have. Six manifests move together, and `.release-please-manifest.json` must agree with them or `verify-release-state.sh` fails the next Release run:
