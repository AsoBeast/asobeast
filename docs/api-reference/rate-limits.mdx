...
The keyword field accepts ten times the 100 characters Apple indexes, because the editor reports how far over the real limit a draft is rather than refusing to store it.
