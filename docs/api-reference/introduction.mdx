...
The API speaks JSON only, which is what a script should read. CSV is a dashboard feature: the keyword monitor, the rankings view, the competitors page, the reviews list and the top 10 sheet each export what they show, with the filters you applied. See [Export data](/guides/export-data).
